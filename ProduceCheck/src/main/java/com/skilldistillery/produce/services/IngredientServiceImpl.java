...
public class IngredientServiceImpl implements IngredientService {
	...
	public List<Ingredient> categoryUnificationProcessor(List<Ingredient> ingredients) {
		...
		/* 
		 * ---- Persistence Layer Storage Checks----
		 * SKIPS INGREDIENTS THAT ALREADY EXIST
		 * Prevent unnecessary database transactions.
		 * Move All categories on ingredient list into a set
		 * check and pull from database existing categories to preserve uniqueness 
		 * */
